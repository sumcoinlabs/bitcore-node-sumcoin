...
function checkConfigVersion2(fullConfig) {
  ...
  if (!datadirUndefined || addressDefined || dbDefined) {
    ...
    console.warn('\nConfiguration file is not compatible with this version. \n' +
                 'A reindex for sumcoind is necessary for this upgrade with the "reindex=1" sumcoin.conf option. \n' +
                 'There are changes necessary in both sumcoin.conf and bitcore-node.json. \n\n' +
