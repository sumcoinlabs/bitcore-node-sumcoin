...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `sumcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ sumcore-node add wallet-service');
      console.log('    $ sumcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ sumcore-node remove wallet-service');
      console.log('    $ sumcore-node remove insight-api');
      console.log();
    });
